...
public class Adresse {
	...
	public void chemin(){
		String rep ="test";  //test étant le nom d'un dossier qui se trouve a la racine de mon projet
	...
	/**
	 *  le code postal pour assignation.
	 */
	...
	/**
	 * @ le numéro pour attribution, il doit être positif
	 */
